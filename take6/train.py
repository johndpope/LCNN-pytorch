...
from LookupConv2d import LookupAlignConvolution2d
...
class MyModel(nn.Module):
    def __init__(self, num_attributes):
        ...
        self.conv1 = LookupAlignConvolution2d(in_channels=3, out_channels=64, kernel_size=3, stride=1, padding=1, 
                                              dict_size=256, param_lambda=0.3, initial_sparsity=0.5, use_cuda=True)
        self.relu = nn.ReLU()
...
if __name__ == '__main__':
    ...
    # Training function
    def train(model, dataloader, criterion, optimizer, epoch, accumulation_steps=4):
        model.train()
        running_loss = 0.0
